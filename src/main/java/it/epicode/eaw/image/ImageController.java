...
public class ImageController {
	 ...
	 public ResponseEntity<String> trovaImmagine(@PathVariable Long id) throws UnsupportedEncodingException {
	     ...
	     if (image.isPresent()) {
	         String encodedUrl = URLEncoder.encode("http://localhost:8081/api/images/immagini/" + id, StandardCharsets.UTF_8.toString());
	         String imageUrl = "http://localhost:8081/api/images/visualizza?imageUrl=" + encodedUrl;
